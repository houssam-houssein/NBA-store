...
const Navbar = () => {
  ...
  const handleHighSchoolAthletesClick = (e) => {
    e.preventDefault()
    if (location.pathname === '/') {
      // Already on homepage, scroll to section
      const section = document.getElementById('high-school-athletes')
      if (section) {
        section.scrollIntoView({ behavior: 'smooth' })
      }
    } else {
      // Navigate to homepage then scroll
      navigate('/#high-school-athletes')
      setTimeout(() => {
        const section = document.getElementById('high-school-athletes')
        if (section) {
          section.scrollIntoView({ behavior: 'smooth' })
      ...
      <div className="navbar-container">
        ...
        <div className="navbar-right-group">
          ...
          <div className="navbar-links">
            ...
            <a href="#high-school-athletes" className="nav-link" onClick={handleHighSchoolAthletesClick}>
