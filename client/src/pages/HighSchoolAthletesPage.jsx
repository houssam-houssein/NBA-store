  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const highSchoolCategory = categories.find(cat => 
          cat.key && cat.key.toLowerCase() === 'highschoolathletes'
        )
        
        if (highSchoolCategory && highSchoolCategory.products) {
          setProducts(highSchoolCategory.products.filter(p => p != null))
        }
      } catch (error) {
          ...
          {products.map((product) => (
            ...
            >
              ...
              <div className="product-overlay">
                ...
                <p className="product-price-overlay">{formatPrice(product.price)}</p>
              </div>
            </div>
          ))}
        </section>
